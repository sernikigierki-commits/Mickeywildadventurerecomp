...
set(PSXRECOMP_RUNTIME_SOURCES
    ...
    ${PSXRECOMP_ROOT}/runtime/src/mickey_frontend.cpp
    ${PSXRECOMP_ROOT}/runtime/src/mickey_profiles.cpp
...
function(psxrecomp_add_runtime_target target)
    ...
    elseif(ANDROID)
        target_link_libraries(${target} PRIVATE GLESv3 EGL log android)
    else()
        if(CMAKE_DL_LIBS)
