...
#if defined(__ANDROID__) && defined(PSX_NO_DEBUG_TOOLS) && defined(__arm__)
    if (resume_pc == 0x8007FE34u) {
        extern void mickey_armv7_wait_accel(CPUState *cpu);
        mickey_armv7_wait_accel(cpu);
    }
#endif
